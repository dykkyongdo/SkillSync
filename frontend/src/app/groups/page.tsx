        ...
        <RequireAuth>
            <main className="relative isolate pt-14">
                ...
                <div className="absolute inset-0 -z-10 pointer-events-none
                        ...
                        bg-[size:48px_48px] dark:bg-[linear-gradient(to_right,rgba(255,255,255,0.14)_2px,transparent_2px),linear-gradient(to_bottom,rgba(255,255,255,0.14)_2px,transparent_2px)]"
                />
                ...
                <section className="min-h-[calc(100vh-3.5rem)] px-4 py-8 relative z-0">
                    <div className="mx-auto max-w-6xl">
                                ...
                                <DialogContent className="rounded-base border-2 border-border shadow-shadow">
                                    ...
                                    <form onSubmit={handleCreateGroup} className="grid gap-5">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Textarea id="group-desc" placeholder="Short blurb about this group..."
                                            value={description}
                                        ...
                                        {formError && (
                                            <p className="text-sm font-medium text-red-600">(fromError)</p>
                                        )}
                        ...
                        {groups.map((group) => (
                            ...
                            <CardContent>
                                <p className="mb-4 text-sm text-foreground/70 font-medium">
